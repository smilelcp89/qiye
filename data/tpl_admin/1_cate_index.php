...
<tr<?php if($key%2 == ""){ ?> class="list"<?php } ?>>
	...
	<td><span class="status<?php echo $value['status'];?>" id="status_<?php echo $value['id'];?>" onclick="phpok_status(<?php echo $value['id'];?>,'<?php echo phpok_url(array('ctrl'=>'cate','func'=>'status'));?>')" value="<?php echo $value['status'];?>"></span></td>
	<td>
