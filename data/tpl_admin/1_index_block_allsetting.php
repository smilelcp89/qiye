...
<div class="box_item">
	<ul>
		...
		<li><a title="<?php echo P_Lang("在线发邮件");?>" href="javascript:$.win('<?php echo P_Lang("发邮件");?>','<?php echo phpok_url(array('ctrl'=>'all','func'=>'email'));?>');void(0);">
			<div class="top_img"><img src="images/ico/email.png" alt="<?php echo P_Lang("在线发邮件");?>" class="ie6png" width="48" height="48" /></div>
			<div class="name"><?php echo P_Lang("发邮件");?></div></a>
		</li>
		<?php } ?>
